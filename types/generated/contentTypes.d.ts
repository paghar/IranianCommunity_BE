...
export interface ApiCommunityInfoCommunityInfo extends Schema.CollectionType {
  collectionName: 'community_infos';
  info: {
...
export interface ApiPlanPlan extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['event', 'project']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    slug: Attribute.UID<'api::plan.plan', 'title'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::community-info.community-info': ApiCommunityInfoCommunityInfo;
